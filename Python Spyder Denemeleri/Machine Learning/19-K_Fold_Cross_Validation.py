# -*- coding: utf-8 -*-
"""
Created on Fri Mar 24 04:25:45 2023
...
# k degerimiz 3 ve cv degerimiz 10 traini 10 a bolup 9 u train 1 i ise validation olarak alacagiz
accuracies = cross_val_score(estimator = knn, X = x_train, y = y_train, cv = 10)
print("average accuracy: ", np.mean(accuracies))
print("(tutarlılığı)average std: ", np.std(accuracies))
...
print("tuned hyperparameter: (best )", logreg_cv.best_params_)
